...
const groups = {
  ...
  fabric: ["All", "Pure Silk", "Georgette", "Cotton", "Chiffon", "Linen", "Net", "Tussar Silk", "Organza"],
  color: ["All", "Red", "Blue", "Green", "Yellow", "Purple", "White", "Maroon", "Orange", "Pink", "Ivory"],
  occasion: ["All", "Wedding", "Party", "Casual", "Festival", "Office", "Ethnic", "Reception"],
};
